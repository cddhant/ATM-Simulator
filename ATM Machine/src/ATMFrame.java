...
// Initialize the contents of the app frame
	private void initialize() {
		
		Card c1 = new Card(1, 1234, 15000);
		Card c2 = new Card(2, 5678, 45000);
		Card c3 = new Card(3, 9101, 12000);
		...
		lblEnterAmountW.setBounds(114, 84, 250, 14);
		...
		lblBalance.setBounds(10, 27, 100, 14);
		panel.add(lblBalance);
		
		JLabel lblWithdrawal = new JLabel("WITHDRAW");
		lblWithdrawal.setVisible(false);
		lblWithdrawal.setFont(new Font("Tahoma", Font.PLAIN, 15));
		lblWithdrawal.setBounds(10, 177, 100, 15);
		...
		lblDeposit.setBounds(342, 172, 110, 20);
		...
		lblEnterPin.setBounds(165, 84, 100, 14);
		...
		lblInco.setBounds(150, 147, 100, 14);
		panel.add(lblInco);
		...
		lblAccountBalance.setBounds(146, 84, 150, 14);
		...
		JLabel lblInsufficient = new JLabel("Insufficient money!");
		...
		lblInsufficient.setBounds(140, 147, 150, 14);
		...
		lblTransaction.setBounds(83, 109, 350, 23);
		panel.add(lblTransaction);
		
		JLabel lblWelcome = new JLabel("Welcome to XYZ Bank!");
		...
		lblEnterAmountD.setBounds(124, 81, 200, 20);
		...
		Image image = new ImageIcon(this.getClass().getResource("images/card.png")).getImage().getScaledInstance(180, 240, Image.SCALE_DEFAULT);
		...
		Image image_money = new ImageIcon(this.getClass().getResource("images/500note.png")).getImage().getScaledInstance(350, 150, Image.SCALE_DEFAULT);
		lblMoney.setVisible(false);
